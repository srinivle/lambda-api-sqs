...
resource "aws_sqs_queue" "sample_queue" {
  ...
  redrive_policy = jsonencode({
    deadLetterTargetArn = aws_sqs_queue.sample_queue_deadletter.arn
    maxReceiveCount     = 4
  })
...
resource "aws_sqs_queue" "sample_queue3" {
  depends_on = [ aws_sqs_queue.sample_queue, /*aws_sqs_queue.sample_queue1,*/ aws_sqs_queue.sample_queue2, aws_sqs_queue.sample_queue_deadletter ]
  name = "sample-queue3"

  redrive_policy = jsonencode({
    deadLetterTargetArn = aws_sqs_queue.sample_queue_deadletter.arn //aws_sqs_queue.sample_queue_deadletter.arn
    maxReceiveCount     = 10
  })
}

resource "aws_sqs_queue_redrive_allow_policy" "sample_queue_redrive_allow_policy" {
  depends_on = [ aws_sqs_queue.sample_queue, /*aws_sqs_queue.sample_queue1,*/ aws_sqs_queue.sample_queue2, aws_sqs_queue.sample_queue3, aws_sqs_queue.sample_queue_deadletter ]
  queue_url = aws_sqs_queue.sample_queue_deadletter.id
...
resource "aws_sqs_queue" "sample_queue4" {
  ...
  depends_on = [ aws_sqs_queue.sample_queue, /*aws_sqs_queue.sample_queue1,*/ aws_sqs_queue.sample_queue2, aws_sqs_queue.sample_queue3 ]
